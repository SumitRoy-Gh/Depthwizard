...
def main():
    ...
    from depthwizard.tests import test_pseudo_depth
    ...
    print("\nRunning test_losses...")
    from depthwizard.tests import test_losses
    ...
    from depthwizard.tests import test_finetune_dataset
    test_finetune_dataset.test_dataset_and_collate()
    
    print("\nRunning test_dav2_backbone_frozen_flag...")
    from depthwizard.tests import test_dav2_backbone_frozen_flag
