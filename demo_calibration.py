...
def main():
    ...
    from preprocessing.stages.resolution_handling import align_dataset_to_common_gsd_with_semantics
    from preprocessing.stages.tiling import crop_patches_with_semantics
    from calibration.region_calibration import (
